...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
        ...
        Invite = "https://discord.gg/TY4TKrmpdd", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
     ...
     KeySettings = {
        Title = "Untitled",
        Subtitle = "Key Système",
        Note = "No method of obtaining the key is provided", -- Use this to tell the user how to get a key
        FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
        SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
        GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
        Key = {"https://pastebin.com/raw/HuWWinWN"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
     }
  })
...
Player.CharacterAdded:Connect(function(char)
    ...
    -- Réappliquer WalkSpeed et JumpPower à chaque changement de Humanoid
